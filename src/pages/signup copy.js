    ...
    if (username === undefined || username === null || username === "") {
      ...
      try {
        const { data } = await axios
          .post('http://bhs07511.uta.cloud/mercadodynamic/backendphp/signup.php', config)
          .then((response) => {
            ...
            <div id="card_item">
              <div id="card_innersignup">
                ...
                <div id="formgroupmain">
                  ...
                  <label  id="login-input" for="actor">Student</label>
                  <input id="actor" type="radio" name="role" value="Student" onChange={(e) => setActor(e.target.value)}  required />

                  <label  id="login-input" for="actor">Business Owner</label>
                  <input id="actor" type="radio" name="role" value="Business Owner" onChange={(e) => setActor(e.target.value)} />

                  <label  id="login-input" for="actor">School Admin</label>
                  <input id="actor" type="radio" name="role" value="School Admin" onChange={(e) => setActor(e.target.value)} />
                </div>

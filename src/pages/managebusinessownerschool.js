...
function ManageBusinessOwnerSchool() {
  const navigate = useNavigate();
    ...
    useEffect(() => {
      ...
      fetch("http://localhost/backendphp/managebusinessownerschool.php")
        .then((res) => res.json())
        .then((result) => {
          setItem(result);
        console.log(result);
  ...
  const deleteRow = async (email) => {
    ...
    axios.post('http://localhost/backendphp/managebusinessownerdelete.php', config)
      .then((response) => {
      ...
      <div id="blockhead">
        <div id="mainblock">
          ...
          <section id="middleblock">
            <p id="caption">Manage Business Owners</p>

            <table id="table_gap">
              <tr>
                <th id="table_setting">Business Owner</th>
                <th id="table_setting">Name</th>
                <th id="table_setting">Business Name</th>
...
export default ManageBusinessOwnerSchool;
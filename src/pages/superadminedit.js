      ...
      <div id="body">
        ...
        <div id="service-div">
          ...
          <form onSubmit={registerHandle} method='post'>
              ...
              <label for="actor">Super Admin</label>
              <input id="actor" type="radio" name="role" value="Super Admin" onChange={(e) => setActor(e.target.value)} style={{ height: 15, width: 'auto' }} required />
               </div>

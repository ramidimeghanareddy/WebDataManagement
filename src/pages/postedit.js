...
//   const [actor, setActor] = useState('')
  ...
  const registerHandle = async (e) => {
    e.preventDefault();
     const options = { method: 'POST', email:userdata, postname:postname, post_description:post_description, 
     student_manager:student_manager, 
     contact_number:contact_number, website:website,post_id:product_id };
    try {
      const { data } = await axios
      .post("http://localhost/backendphp/postedit.php/?email="+userdata,options)
        .then((response) => {
    ...
    useEffect(() => {
      ...
      var product_id = localStorage.getItem('post_id')
